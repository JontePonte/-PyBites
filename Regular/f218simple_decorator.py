...
Complete the sandwich decorator which takes a function and prints 
=== Upper bread slice === (defined in UPPER_SLICE) and 
=== Lower bread slice === (defined in LOWER_SLICE) 
...
Even so decorators can be confusing when you start using them so here is an article we wrote 
some time ago: Learning Python Decorators by Example.
"""
